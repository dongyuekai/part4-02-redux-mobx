...
class TodoExtra extends Component {
  render() {
    const { unfinishedTodoCount, changeFilter, filter, todoDelteCompleted } = this.props.todo;
    return (
      <footer className='footer'>
        ...
        <button className="clear-completed" onClick={() => todoDelteCompleted()}>Clear completed</button>
      </footer>
    )
  }
}
